...
use crate::{
    ...
    calc::statistics::statistic_analyzer_collector::{
        ItemRouteNodeRef, ItemRouteRef, StatisticAnalyzerCollectorTrait, calculate_crafting_paths,
        finalize_routes,
    },
};
...
impl StatisticAnalyzer for UniquePathChanceStatisticAnalyzer {
    ...
    fn get_description(&self) -> &'static str {
        "Retrieves N unique paths from all possible combinations, sorted by chance."
    }
