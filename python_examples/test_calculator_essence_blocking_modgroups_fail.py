...
def main():
    ...
    with open('example_items/startitem_illegal_essence.json', 'r', encoding='utf-8') as f:
        start_raw_string = f.read()
    with open('example_items/targetitem_illegal_essence.json', 'r', encoding='utf-8') as f:
