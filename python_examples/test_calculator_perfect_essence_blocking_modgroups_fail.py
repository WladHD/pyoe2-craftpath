...
def main():
    ...
    with open('example_items/startitem_illegal_perfect_essence.json', 'r', encoding='utf-8') as f:
        start_raw_string = f.read()
    with open('example_items/targetitem_illegal_perfect_essence.json', 'r', encoding='utf-8') as f:
