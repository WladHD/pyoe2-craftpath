...
macro_rules! impl_common_group_analyzer_methods {
    () => {
        fn calculate_chance_for_group_step_index(
            &self,
            group_routes: &Vec<Vec<crate::features::analysis::helpers::RouteChance>>,
            subpath_amount: crate::features::analysis::helpers::SubpathAmount,
            index: usize,
        ) -> crate::features::analysis::helpers::RouteChance {
            use crate::features::analysis::helpers::RouteChance;
        ...
        fn calculate_cost_per_craft(
            &self,
            currency: &Vec<crate::domain::currency::CraftCurrencyList>,
            item_info: &crate::domain::provider::item_info::ItemInfoProvider,
            market_provider: &crate::domain::provider::market_prices::MarketPriceProvider,
        ) -> crate::domain::provider::market_prices::PriceInDivines {
            let pc = crate::domain::provider::market_prices::PriceInDivines::new(
...
macro_rules! impl_common_unique_path_analyzer_methods {
    () => {
        ...
        fn calculate_cost_per_craft(
            ...
            crate::domain::provider::market_prices::PriceInDivines::new(currency.iter().fold(
                0.0_f64,
                |a, b| {
                    a + b.list.iter().fold(0.0_f64, |a, b| {
                        a + market_provider
