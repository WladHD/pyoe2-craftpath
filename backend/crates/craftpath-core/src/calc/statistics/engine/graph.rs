...
pub(crate) mod test_support {
    ...
    use crate::api::types::{BaseItemId, ItemLevel, ItemRarityEnum, THashMap, THashSet};
    ...
    pub fn empty_providers() -> (
        crate::api::provider::item_info::ItemInfoProvider,
        crate::api::provider::market_prices::MarketPriceProvider,
    ) {
        (
            crate::api::provider::item_info::ItemInfoProvider {
