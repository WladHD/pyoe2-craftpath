...
class CraftCurrencyEnum:
    ...
    @typing.final
    class OmenOfLight(CraftCurrencyEnum):
        __match_args__ = ()
        def __new__(cls) -> CraftCurrencyEnum.OmenOfLight: ...
        def __len__(self) -> builtins.int: ...
        def __getitem__(self, key: builtins.int) -> typing.Any: ...
    ...
    @typing.final
    class OmenOfGreaterExaltation(CraftCurrencyEnum):
        __match_args__ = ()
        def __new__(cls) -> CraftCurrencyEnum.OmenOfGreaterExaltation: ...
        def __len__(self) -> builtins.int: ...
        def __getitem__(self, key: builtins.int) -> typing.Any: ...
...
@typing.final
class EssenceKindEnum(enum.Enum):
    r"""
