...
class Calculator:
    ...
    def __str__(self) -> builtins.str: ...
    @staticmethod
    def generate_item_matrix(starting_item: ItemSnapshot, target: ItemSnapshot, item_provider: ItemInfoProvider, market_info: MarketPriceProvider, matrix_builder: MatrixBuilderPreset) -> Calculator: ...
    def calculate_statistics(self, item_provider: ItemInfoProvider, market_provider: MarketPriceProvider, max_routes: builtins.int, max_ram_in_bytes: builtins.int, statistic_analyzer: StatisticAnalyzerPathPreset) -> StatisticResult: ...
    def calculate_statistics_currency_group(self, item_provider: ItemInfoProvider, market_provider: MarketPriceProvider, max_ram_in_bytes: builtins.int, statistic_analyzer: StatisticAnalyzerCurrencyGroupPreset) -> builtins.list[GroupRoute]: ...
    @staticmethod
...
class DynStatisticAnalyzerCurrencyGroups:
    ...
    def calculate_weight_for_60_percent(self, group_route: GroupRoute, item_provider: ItemInfoProvider, market_provider: MarketPriceProvider) -> builtins.float: ...
    def calculate_weight_for_group_step_index(self, group_routes: typing.Sequence[typing.Sequence[builtins.float]], index: builtins.int) -> builtins.float: ...
    def template_weight_for_group_step_index(self, weight: builtins.float) -> builtins.str: ...
    def template_group_weight_name(self) -> builtins.str: ...
    def template_60_percent_group_name(self) -> builtins.str: ...
    def format_group_weight(self, weight: builtins.float) -> builtins.str: ...
    def format_60_percent_group_weight(self, weight: builtins.float) -> builtins.str: ...
...
class GroupRoute:
    ...
    @property
    def unique_route_weights(self) -> builtins.list[builtins.list[builtins.float]]: ...
    def __str__(self) -> builtins.str: ...
...
class StatisticAnalyzerCurrencyGroupPreset(enum.Enum):
    ...
    def get_statistic_analyzer_instance(self) -> DynStatisticAnalyzerCurrencyGroups: ...
...
class StatisticAnalyzerPathPreset(enum.Enum):
    ...
    def get_statistic_analyzer_instance(self) -> DynStatisticAnalyzerPaths: ...
