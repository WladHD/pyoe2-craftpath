...
class Calculator:
    ...
    def calculate_statistics(self, item_provider: ItemInfoProvider, market_provider: MarketPriceProvider, max_routes: builtins.int, max_ram_in_bytes: builtins.int, statistic_analyzer: DynStatisticAnalyzerPaths) -> StatisticResult: ...
...
class DynStatisticAnalyzerCurrencyGroups:
    ...
    def calculate_weight_for_group_step_index(self, group_routes: typing.Sequence[typing.Sequence[tuple[RouteCustomWeight, RouteChance, builtins.int]]], index: builtins.int) -> RouteChance: ...
...
class GroupRoute:
    ...
    @property
    def unique_route_weights(self) -> builtins.list[builtins.list[tuple[RouteCustomWeight, RouteChance, builtins.int]]]: ...
    @property
