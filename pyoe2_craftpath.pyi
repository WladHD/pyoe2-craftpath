...
class Calculator:
    ...
    def calculate_statistics_currency_group(self, item_provider: ItemInfoProvider, market_provider: MarketPriceProvider, max_ram_in_bytes: builtins.int, statistic_analyzer: StatisticAnalyzerCurrencyGroupPreset) -> builtins.list[tuple[builtins.list[CraftCurrencyList], builtins.float, builtins.list[builtins.list[builtins.float]]]]: ...
    @staticmethod
